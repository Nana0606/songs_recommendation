				...
				[ function() {
					return {
						...
						template : '<div class="page-list">'
								...
								+ '第<input type="text" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)" style="color:#000000" />页 '
								+ '每页<select ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()" style="color:#000000"></select>'
						...
						link : function(scope, element, attrs) {
							...
							function getPagination() {
								...
								scope.conf.numberOfPages = Math
										.ceil(scope.conf.totalItems
												/ scope.conf.itemsPerPage);
							...
							scope.jumpToPage = function() {
								scope.jumpPageNum = scope.jumpPageNum.toString().replace(
										/[^0-9]/g, '');
							...
							scope
									.$watch(
											function() {
												var newValue = scope.conf.currentPage
														+ ' '
