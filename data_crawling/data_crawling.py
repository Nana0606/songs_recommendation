...
def get_lyrics_list(album_ids, lyrics_list_url_current, lyrics_list_headers, f_path):
    ...
    with open(f_path + "lyricsList.txt", 'a', encoding='utf-8') as f:
        for album_id in album_ids:
            ...
            html_lyricsList = etree.HTML(response_lyrics_list.text)
...
if __name__ == '__main__':
    ...
    # 专辑地址和headers
    singer_id = 3686   # 歌手id，可以在网易云音乐网站上搜索自己喜欢歌手的ID
    album_url = "https://music.163.com/artist/album?id=" + str(singer_id) + "&limit=1000&offset=0"
    album_headers = {
